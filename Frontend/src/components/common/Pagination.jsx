    ...
    <div className="bg-[#F3F6F9] h-[73px] px-[16px] flex items-center justify-center border-[rgba(130,143,143,0.25)] rounded-b-[12px] border-t-[1px]">
      <nav className="relative z-0 inline-flex flex-row items-center justify-center px-[6px] gap-[6px] h-[40px]" aria-label="Pagination">
        ...
        <button
          onClick={() => goToPage(1)}
          disabled={safePage === 1}
          className="box-border relative w-[40px] h-[40px] opacity-38 border border-[rgba(130,143,143,0.25)] rounded-full flex items-center justify-center text-[#212121] bg-transparent disabled:cursor-not-allowed"
        >
          ...
          <button
            ...
            className={`box-border relative w-[40px] h-[40px] rounded-full flex items-center justify-center ${
              num === safePage
                ...
                : 'bg-[rgba(130,143,143,0.25)] border border-[rgba(130,143,143,0.25)]'
            }`}
          >
        ...
        <button
          ...
          className="box-border relative w-[40px] h-[40px] bg-white opacity-38 border border-[rgba(130,143,143,0.25)] rounded-full flex items-center justify-center text-[#212121] disabled:cursor-not-allowed"
        >
